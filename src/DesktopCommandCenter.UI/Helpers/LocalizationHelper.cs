...
public class LocalizationHelper : INotifyPropertyChanged
{
    ...
    public string CurrentCulture => _translationService?.CurrentCulture ?? "pt-BR";

    public string this[string key] => _translationService != null ? _translationService.Get(key) : key;
    ...
    public string GetString(string key) => _translationService != null ? _translationService.Get(key) : key;
