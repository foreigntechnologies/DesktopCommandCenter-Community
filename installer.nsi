...
!define MUI_FINISHPAGE_SHOWREADME_TEXT "Criar atalho na Ãrea de Trabalho"
...
IsRunning:
  MessageBox MB_YESNO|MB_ICONEXCLAMATION "O Desktop Command Center estÃ¡ em execuÃ§Ã£o em segundo plano.$\n$\nDeseja fechÃ¡-lo automaticamente para continuar a instalaÃ§Ã£o?" IDYES KillApp IDNO AbortInstall
...
AbortInstall:
  Abort "InstalaÃ§Ã£o cancelada pelo usuÃ¡rio."
